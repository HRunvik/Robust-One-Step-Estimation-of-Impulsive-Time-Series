function [a1est,m1val] = gammaCurve_basal_robust(a1_range,a2,l_range,y,t_sampled,options,bigstep,epsilon,ressumeps)
%		Same as gammaCurve_basal, but with robust least squares
    ...
    if mod(k2,bigstep)==1
        if k2>1
            ...
            for k1=1:numel(a1grid)
                ...
                [ressumgrad(k1),ressumDer(k1)]=ressumgrad_robust(pars,y-l,t_sampled,options,epsilon,a_delta_small,ressumeps);
            end
